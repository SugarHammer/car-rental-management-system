...
public class MenuController {
    ...
    public String getMenu(HttpServletRequest request) {
		...
		if (1 == level) {
			...
			array.add(getJsonObject("messageInfo", "留言板", "layui-icon-table", "messageInfo"));
			array.add(getJsonObject("checkInfo", "人员检测信息", "layui-icon-table", "checkInfo"));
			array.add(getJsonObject("submitInfo", "事故检查", "layui-icon-table", "submitInfo"));
			array.add(getJsonObject("richtextInfo", "政策信息宣传", "layui-icon-table", "richtextInfo"));
			array.add(getJsonObject("advertiserInfo", "通知管理", "layui-icon-table", "advertiserInfo"));
			array.add(getJsonObject("typeInfo", "汽车类型", "layui-icon-table", "typeInfo"));
			array.add(getJsonObject("goodsInfo", "汽车详情管理", "layui-icon-table", "goodsInfo"));
